...
*/
/*! \file bp_support_sada_onlymin.hpp
    \brief bp_support_sada_onlymin.hpp contains an implementation of a balanced
     parentheses support structure proposed by Kunihiko Sadakane.
    \author Simon Gog
*/
#ifndef INCLUDED_SDSL_bp_support_sada_onlymin_ONLYMIN
#define INCLUDED_SDSL_bp_support_sada_onlymin_ONLYMIN
...
class bp_support_sada_onlymin
{
    ...
    private:
        static_assert(0 < t_sml_blk, "bp_support_sada_onlymin: t_sml_blk should be greater than 0!");
...
//#define USE_CACHE
        ...
        void copy(const bp_support_sada_onlymin& bp_support)
        {
    ...
    public:
        ...
        bp_support_sada_onlymin() {}

        //! Constructor
        explicit bp_support_sada_onlymin(const bit_vector* bp): m_bp(bp),
        ...
        //! Copy constructor
        bp_support_sada_onlymin(const bp_support_sada_onlymin& bp_support)
        {
            copy(bp_support);
        }

        //! Move constructor
        bp_support_sada_onlymin(bp_support_sada_onlymin&& bp_support)
        {
            *this = std::move(bp_support);
        }

        //! Assignment operator
        bp_support_sada_onlymin& operator=(bp_support_sada_onlymin&& bp_support)
        {
            if (this != &bp_support) {
         ...
         */
        void swap(bp_support_sada_onlymin& bp_support)
        {
        ...
        //! Assignment operator
        bp_support_sada_onlymin& operator=(const bp_support_sada_onlymin& bp_support)
        {
            if (this != &bp_support) {
                copy(bp_support);
            }
        ...
        /*
                bp_support_sada_onlymin& operator=(bp_support_sada_onlymin&& bps)
                {
                    this->swap(bps);
                    return *this;
                }
	  ...
	  return bwd_excess(i, -2)+1;
        ...
        //! Serializes the bp_support_sada_onlymin to a stream.
        /*!
        ...
        //! Load the bp_support_sada_onlymin for a bit_vector v.
        /*!
